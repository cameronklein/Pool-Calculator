...
class TermsOfUseViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    text = text + "\n\nAlways double check pool chemical calculations before adding chemicals and wear proper personal protective equipment. Use best practices when adding chemicals to pools and never mix chemicals together. Follow local laws and regulations when handling chemicals."
    label1.text = text
  }
